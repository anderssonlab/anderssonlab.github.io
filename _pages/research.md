...
![]({{ site.url }}{{ site.baseurl }}/images/respic/EP_graphic.jpg){: style="width: 100%; float: left; margin: 10px"}
...
![]({{ site.url }}{{ site.baseurl }}/images/respic/challenges.jpg){: style="width: 60%; float: left; margin: 10px"}
