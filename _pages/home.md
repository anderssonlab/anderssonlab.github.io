---
title: "Andersson Lab - Home"
layout: homelay
excerpt: "Andersson Lab at University of Copenhagen."
sitemap: false
permalink: /
---

![]({{ site.url }}{{ site.baseurl }}/images/Andersson_Lab_logo_small.png){: style="width: 50%; float: left; margin:0px"}
...
![]({{ site.url }}{{ site.baseurl }}/images/teampic/team_2022.jpg){: style="width: 60%; float: left; margin: 30px"} 
